"""Fetch everything Nexus needs to run: the Piper binary, a voice, and the speech model.
...
on first run; both go through :mod:`nexus.core.assets`.
"""
...
def main() -> int:
    ...
    nexus_logging.configure(level="INFO", quiet_libraries=True, to_file=False)
    ...
    print("\nDone. Set NEXUS_VOICE in .env to choose between installed voices.")
    return 0
