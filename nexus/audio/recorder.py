...
``always_on=False``
    ...
    so nothing is capturable while Nexus is idle. Stricter, at the cost of the
    ...
    def begin_capture(self, *, use_preroll: bool = True) -> None:
        ...
        Args:
            use_preroll: Include the moment before the key was pressed. Set
                False when interrupting Nexus mid-sentence: on speakers the
                pre-roll holds Nexus's own voice, which would otherwise be
