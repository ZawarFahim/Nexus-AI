...
synthesis time to the silence before Nexus makes a sound, and that silence would
...
from nexus.audio.devices import DeviceInfo, resolve_device
...
class StreamingPlayer:
    ...
    def _ensure_stream(self) -> None:
        ...
        recovery Nexus stays mute until it is restarted, which reads as a crash.
        ...
        try:
            self.start()
        except (PlaybackError, Exception):  # noqa: BLE001 -- keep Nexus alive
    ...
    def wait_until_drained(self, timeout: float | None = None) -> bool:
        ...
        while self.pending_seconds > 0:
            ...
            if stream is None or not stream.active:
                ...
                # freezing Nexus for as long as it allows.
    ...
    def flush(self) -> None:
        ...
        Used to interrupt Nexus mid-sentence. Only audio already handed to the
