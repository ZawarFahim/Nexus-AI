...
produce compliance, not personality. What follows describes who Nexus is and
...
_TEMPLATE: Final = """\
You are Nexus. You are talking with a friend, out loud, in real time.
...
# These describe *behaviour*, not triggers. Which phrasings should make Nexus
...
# Nexus could do with a new capability, and a model that knows it *can* look tends
# to look constantly, which would quietly break the promise Nexus was built on.
_SCREEN_TOOL: Final = """\
...
def build_system_prompt(
    ...
    What Nexus can do is described here rather than left to the tool definitions
    ...
    Note:
        ...
        capability Nexus does not have produces a confident description of a
