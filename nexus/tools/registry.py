...
and kill the turn, leaving the user with silence -- the failure mode Nexus spent a
...
class ToolRegistry:
    """Holds the available tools. Satisfies :class:`~nexus.core.protocols.Toolbox`.

    Args:
        tools: Capabilities to expose. An empty registry is valid and means
            Nexus is a pure conversationalist.
    """
...
def _parse_arguments(raw: str) -> dict[str, Any]:
    ...
    # eventually answer without ever having looked -- which reads as Nexus simply
