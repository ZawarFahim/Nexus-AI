"""Letting Nexus look at the screen, when asked.

This is the first thing Nexus can do that touches the world outside a
...
logged, so there is a record of exactly when Nexus looked.
