"""Things Nexus can do besides talk.

Each capability is one small module exposing a :class:`~nexus.tools.registry.Tool`.
...
in response to something the user said, which keeps the promise Nexus was built
