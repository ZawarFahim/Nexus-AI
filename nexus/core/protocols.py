"""Interfaces between Nexus's swappable components.
...
keeps the dependency arrow pointing inward: ``nexus.stt`` knows nothing about who
...
from nexus.audio.recorder import AudioClip
...
class Toolbox(Protocol):
    """The things Nexus can do besides talk.
...
class LLMProvider(Protocol):
    ...
    def stream_reply(
        ...
        Streaming is required rather than optional. Nexus begins speaking its
        ...
        time to the pause before Nexus makes a sound.
...
class LLMError(RuntimeError):
    ...
    Nexus has to say what went wrong out loud. "I lost my connection" and "my key
